...
## Setting Up Pre-commit Hooks for rustfmt

### Option 1: Manual Setup

1. Create a `.git/hooks/pre-commit` file in your local repository:
...
1. Committing the `.pre-commit-config.yaml` file to the repository
2. Adding documentation about hook setup in your README or CONTRIBUTING guide
3. Including hook setup in your onboarding process for new contributors
...
2. Check that the hook files have execute permissions
